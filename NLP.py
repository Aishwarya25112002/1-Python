# -*- coding: utf-8 -*-
"""
Created on Fri May 26 08:20:11 2023
...
import nltk
nltk.download('pukt')
sentence_data="The first SEntence is about python.The"
...
german_tokenizer=nltk.data.load('tokenizer/punkt/german.pickle')
german_tokens=german_tokenizer.tokenize('Wie geht es Ihnen?')
...
x= arr[:3, ::2] #All rows three columns,in all selected rows and column every alternate rows
print (x)
# Output : 
# [[10 10]
# [40 70]
...
#The itemsize property is used to get 
#the size of each array item. 
#It returns the number of bytes taken
...
#Use dtype function to check the data type 
#of each array item.  
...
#To get the shape and size of the array, 
#the size and shape function associated 
#with the numpy array is used. 
