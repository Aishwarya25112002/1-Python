# -*- coding: utf-8 -*-
"""
Created on Wed Apr  5 08:52:17 2023
...
if num< 0:
   ...
   #########################################
saving = float(input("Enter how much you have saving:"))
if saving == 0:
...
print('only print code  of all iteraction completed')
...
for i in range(0,16):
    ...
    print('Done')
####################
#Anonymous loop variable(_)called as Underscore
for _ in range(0,10):
    print('.',end='')
    print()
...
for num in range(start,end + 1):
    ...
    if num % 2==0:
        print(num,end=" ")
############
#python program to print all the even number in range
for even_numbers in range(4,15,2):
    print(even_numbers,end=' ')
    
############
for odd_numbers in range(3,15,2):
    print(odd_numbers,end=' ')
    
################
start=int(input("Enter the start in range:"))
end=int(input("Enter the end in range:"))
#iterating each number in list
for num in range(start,end + 1):
    #checking condition
    if num % 2==0:
...
print('Modulus division 3 % 2:', 4 % 2)
'''
